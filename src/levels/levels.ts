...
const L01: LevelConfig = {
  ...
  quest: { type: 'prediction-streak', count: 3, label: 'Call 3 duels correctly in a row' },
...
const L02: LevelConfig = {
  ...
  quest: { type: 'prediction-streak', count: 4, label: 'Call 4 flips in a row (splits count!)' },
